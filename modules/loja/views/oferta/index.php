...
function mostraOferta($oferta, $filtro)
{
    ...
    if( $filtro == 'sem filtro' )
    {
        ...
        echo '
        <div class="oferta">
            <div style="background-image: url(\'images/' . $oferta->oferta_id . '.jpg\');"></div>
        ...
        ?>::<?= $oferta->produto->nome . '</p>
            ...
            <p class="oferta-local">' . $oferta->produtor->pessoa->cidade ?>, <?=
        $oferta->produtor->pessoa->estado . '</p>
